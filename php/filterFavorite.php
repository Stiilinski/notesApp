...
$faveFilter = $_GET['btnfave'] ?? '';

$sql = "SELECT * FROM notes_tbl WHERE notes_status = 'Active' AND notes_favorite = 'favorite' AND user_id = $userID";

if (!empty($faveFilter)) {
    $sql .= " AND (notes_title LIKE :faveFilter)";
}
